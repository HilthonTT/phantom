...
use phantom_core::{Err, Result, debug, err, implement, time::timepoint_from_now};
#[cfg(feature = "url_preview")]
use phantom_core::{debug_warn, rand, warn};
#[cfg(feature = "url_preview")]
...
async fn oembed_recover(&self, _url: &Url, data: UrlPreviewData) -> UrlPreviewData {
    data
}
