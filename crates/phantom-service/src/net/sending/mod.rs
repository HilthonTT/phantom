...
use crate::{
    Dep, accounts::account_data, accounts::presence, accounts::pusher, accounts::users,
    net::client, net::federation, ops::appservice as appservice_service, ops::server_state, rooms,
    ...
    fn build(args: crate::Args<'_>) -> Result<Arc<Self>> {
        ...
        Ok(Arc::new(Self {
            ...
            services: Services {
                ...
                presence: args.depend::<presence::Service>("accounts::presence"),
                ...
                appservice: args.depend::<appservice_service::Service>("ops::appservice"),
                pusher: args.depend::<pusher::Service>("accounts::pusher"),
