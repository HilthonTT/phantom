...
impl Data {
    ...
    pub(super) async fn append_pdu(
        ...
        self.pduid_pdu.raw_put(pdu_id, Json(json)).ok();
        self.eventid_pduid
            .insert(pdu.event_id.as_bytes(), pdu_id)
            .ok();
        self.eventid_outlierpdu.remove(pdu.event_id.as_bytes()).ok();
    }
    ...
    pub(super) fn prepend_backfill_pdu(
        ...
        self.pduid_pdu.raw_put(pdu_id, Json(json)).ok();
        self.eventid_pduid.insert(event_id, pdu_id).ok();
    ...
    pub(super) async fn replace_pdu(
        ...
        self.pduid_pdu.raw_put(pdu_id, Json(pdu_json)).ok();
